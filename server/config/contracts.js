...
export const handoffManagerContract = loadContract("HandoffManager", path.resolve(__dirname, "../../frontend/contracts/HandoffManagerProxy.json"));
export const insuranceContract = loadContract("Insurance", path.resolve(__dirname, "../../frontend/contracts/Insurance.json"));
