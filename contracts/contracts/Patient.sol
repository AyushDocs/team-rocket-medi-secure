...
contract Patient is ERC721URIStorage {
    ...
    /**
     * @dev Step 1: Log an emergency "Break-Glass" access event
     */
    ...
    /**
     * @dev Step 2: Retrieve the audit trail for a patient
     */
