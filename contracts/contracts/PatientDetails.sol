...
contract PatientDetails is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    /**
     * @dev Set or update patient health details (Self-service)
    ...
    /**
     * @dev Set vitals for a patient by an authorized provider (Owner)
     * @param _patient Address of the patient
     * @param _bp Blood pressure
     * @param _heartRate Heart rate
    ...
    function setVitalsForPatient(
        ...
        Vitals storage v = _patientVitals[_patient];
        v.bloodPressure = _bp;
        v.heartRate = _heartRate;
        v.temperature = _temp;
    ...
    /**
     * @dev Trigger a high-priority clinical alert for a patient (Owner/Hospital only)
     * @param _patient Address of the patient
     * @param _issue Description of the clinical alert (e.g., SBP < 90)
     * @param _severity Alert severity (low, medium, high)
     */
    function triggerClinicalAlert(
        ...
        _patientAlerts[_patient].push(EmergencyAlert({
            issue: _issue,
            severity: _severity,
        ...
        emit ClinicalAlertTriggered(_patient, _issue, _severity, block.timestamp);
    }

    /**
     * @dev Get clinical alert history for a patient
     * @param _patient Address of the patient
     */
    function getAlerts(address _patient) external view returns (EmergencyAlert[] memory) {
