    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-outfit overflow-hidden pt-32 pb-20 px-6">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-blue-400/5 rounded-full blur-[120px]"></div>
                <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-indigo-400/5 rounded-full blur-[120px]"></div>
            </div>
            ...
            <div className="max-w-4xl mx-auto space-y-24 relative z-10">
                ...
                >
                    <h1 className="text-5xl md:text-7xl font-black italic tracking-tighter text-slate-900">THE VISION.</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    {[
                        ...
                        <motion.div 
                            ...
                            className="p-8 bg-white border border-slate-100 rounded-[2.5rem] hover:bg-slate-50 transition-all shadow-xl shadow-slate-200/50"
                        >
                            <section.icon className="h-10 w-10 text-blue-600 mb-6" />
                            <h3 className="text-2xl font-black text-slate-900 mb-3 italic">{section.title}</h3>
                            <p className="text-slate-500 text-sm font-medium leading-relaxed">{section.desc}</p>
                        </motion.div>
                    ))}
                </div>
                ...
                <motion.div 
                    ...
                    className="p-12 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-[3rem] border border-blue-100 text-center shadow-lg"
                >
                    <h2 className="text-3xl font-black text-slate-900 italic mb-6">A DECENTRALIZED FUTURE.</h2>
                    <p className="text-slate-600 font-medium max-w-2xl mx-auto italic">
